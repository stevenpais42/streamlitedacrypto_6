...
def load_data():
    ...
    listings =  json.loads(coin_data["props"]["initialState"])["cryptocurrency"]['listingLatest']['data'][1:]
    df = pd.DataFrame(listings)
    df = df.loc[:, [15, 19, 22, 24, 27, 29, 32, 39]]
    df.columns = ['coin_name', 'market_cap', 'percent_change_1h', 'percent_change_24h', 'percent_change_7d', 'price', 'volume_24h', 'coin_symbol']
    return df
